...
def apply_cnn_Frames(dir):
    ...
    for f in x:
        ...
        classes = ['8YearOldHitsaHomeRunBaseball_swing_baseball_f_cm_np1_fr_bad_0.avi_frames',
        'BaseballHitinSlowMotion_swing_baseball_f_nm_np1_fr_bad_0.avi_frames',
        'BaseballHitinSlowMotion_swing_baseball_f_nm_np1_le_bad_1.avi_frames',
        'BaseBallSweetSwingsingle_swing_baseball_f_nm_np1_ba_bad_0.avi_frames',
        'BaseballSwingAnalysis_swing_baseball_f_nm_np1_fr_med_11.avi_frames',
        'BaseballSwingAnalysis_swing_baseball_f_nm_np1_fr_med_12.avi_frames',
        'BaseballSwingAnalysis_swing_baseball_f_nm_np1_fr_med_14.avi_frames',
        'BaseballSwingAnalysis_swing_baseball_f_nm_np1_fr_med_17.avi_frames',
        ...
        'Faith_Rewarded_swing_baseball_f_cm_np1_fr_bad_29.avi_frames',
        ...
        'Faith_Rewarded_swing_baseball_f_nm_np1_fr_bad_55.avi_frames',
        'Faith_Rewarded_swing_baseball_f_nm_np1_fr_bad_56.avi_frames',
        ...
        'Faith_Rewarded_swing_baseball_f_nm_np1_fr_bad_68.avi_frames',
        ...
        'Fellowship_7_swing_baseball_u_nm_np1_fr_bad_14.avi_frames',
        ...
        'The_Matrix_Revolutions_3_swing_baseball_u_nm_np1_fr_bad_0.avi_frames',
        ...
        #print(min_index)
        #print(min_value)
        print("{} => {}=>{}\n".format(filename, classes[min_index],r));
        s="{} => {}=> {}=> {} \n".format(filename, classes[min_index],min_value,r);
        logfile.write(s);
    logfile.close()